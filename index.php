...
<html lang="en">
  ...
  <body>
    <nav>
      ...
      <ul class="nav__links">
        <li class="link"><a href="flight search.php">Flight booking</a></li>
        <li class="link"><a href="#best travellers">Best travellers</a></li>
    ...
    <header class="section__container header__container">
      ...
      <img height="450" src="assets/header.jpg" alt="header" />
    </header>

    <section class="section__container booking__container" id="flight search">
      <div class="booking__nav">
        <span>Economy Class</span>
        <span class="active">Business Class</span>
    ...
    <section class="section__container plan__container">
      ...
      <div class="plan__grid">
        <div class="plan__content">
          ...
          <h4>Travel Requirements for Dhaka</h4>
          <p>
            Stay informed and prepared for your trip to Dhaka with essential
    ...
    <section class="section__container travellers__container" id="best travellers">
      <h2 class="section__header">Best travellers of the month</h2>
      <div class="travellers__grid">
        <div class="travellers__card">
          <img src="assets/traveller1.jpg" alt="traveller" />
        ...
        <div class="travellers__card">
          <img src="assets/traveller2.jpg" alt="traveller" />
          <div class="travellers__card__content">
        ...
        <div class="travellers__card">
          <img src="assets/traveller3.jpg" alt="traveller" />
          <div class="travellers__card__content">
        ...
        <div class="travellers__card">
          <img src="assets/traveller4.jpg" alt="traveller" />
          <div class="travellers__card__content">
      ...
      <div class="section__container footer__container">
        <div class="footer__col">
          ...
          <p>
            ...
            satisfaction and a passion for air travel, Fly-Safe Airlines offers
